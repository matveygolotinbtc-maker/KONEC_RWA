...
const IDL = {
  ...
  instructions: [{ name: 'buy', discriminator: [102, 6, 61, 18, 1, 218, 235, 234], accounts: [
    { name: 'buyer', writable: true, signer: true }, { name: 'sale', writable: true }, { name: 'paymentOption', writable: true }, { name: 'paymentMint' }, { name: 'buyerPaymentAta', writable: true }, { name: 'buyerPosition', writable: true }, { name: 'treasuryAuthority' }, { name: 'treasuryPaymentAta', writable: true }, { name: 'tokenProgram', address: TOKEN_PROGRAM_ID.toBase58() }, { name: 'systemProgram', address: SystemProgram.programId.toBase58() }
